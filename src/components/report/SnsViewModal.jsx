...
const SnsViewModal = ({ isOpen, onClose, data }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex flex-col items-center bg-black/70 backdrop-blur-sm">
            ...
            {/* 스크롤 가능한 문서 영역 */}
            <div className="flex-1 w-full overflow-y-auto p-8 bg-gray-100/50 flex justify-center">
                <div 
                    className="relative bg-white shadow-2xl mb-8"
                    style={{ width: '210mm', minHeight: '297mm' }}
                >
                    {/* 실제 PDF 캡처 대상 */}
                    <div className="p-[20mm] space-y-8">
                    {/* instargram Section */}
                    <section ref={instagramRef} style={{ backgroundColor: '#ffffff' }} className="break-inside-avoid">
                ...
                {/* X (Twitter) Section */}
                <section ref={xRef} style={{ backgroundColor: '#ffffff' }} className="break-inside-avoid">
                    <h3 className="font-serif text-xl font-bold text-slate-900 mb-6 flex items-center gap-2">
                ...
                <section 
                    ref={facebookRef} 
                    style={{ backgroundColor: '#ffffff', pageBreakBefore: 'always' }}
                >
                    <h3 className="font-serif text-xl font-bold text-slate-900 mb-6 flex items-center gap-2">
